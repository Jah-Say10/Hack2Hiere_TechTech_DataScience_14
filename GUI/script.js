    ...
    validerBtn.addEventListener("click", () => 
    {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if(response["good"] <= 0.6)
                {
                    document.getElementById("text").innerHTML = "Il y a un grand nombre de risques liés à l'octroi de crédit à cette personne, il est donc important de faire attention avant de contracter un prêt."
                }
                else
                {
                    document.getElementById("text").innerHTML = "Étant donné que les risques liés à l'octroi de crédit à cette personne sont faibles, vous pouvez accorder le prêt."
